			...
			if ($messages != null)
			{
					...
					if(checkStatus($messages[$x]) == 0)
				{
				   ...
				   --------------------- */
					...
					$punctaj = 0;
					$eval_con = new mysqli("vm1ip", "sampleuser", "samplepassword", "eval");
					...
					if (!file_exists("/var/www/surse/" . (string)$clasa . '/' . $id_problema . '/work/' . $id_eval . '/' . $nume_fisier))
					{
						shell_exec("lftp -u username,password -e 'mirror -c / /var/www/surse; exit' infocloud.server -p 21");
						shell_exec("chmod -R 777 /var/www/surse");
						sleep(5);
					}
					...
					for ($i = 1; $i <= 10; $i++)
					{
						...
						if ($output2 == "timelimit: sending warning signal 15\n")
						{
							...
							$eval_con2 = mysqli_connect("vm1ip", "sampleuser", "samplepassword", "eval");
						...
						{
							$eval_con3 = mysqli_connect("vm1ip", "sampleuser", "samplepassword", "eval");
							if (mysqli_connect_errno())
							{
								echo "Failed to connect to MySQL: " . mysqli_connect_error();
							}
						...
						{
							$eval_con4 = mysqli_connect("vm1ip", "sampleuser", "samplepassword", "eval");
							if (mysqli_connect_errno())
							{
								echo "Failed to connect to MySQL: " . mysqli_connect_error();
							}
					...
					$eval_con5 = mysqli_connect("vm1ip", "sampleuser", "samplepassword", "eval");
					if (mysqli_connect_errno())
					{
						echo "Failed to connect to MySQL: " . mysqli_connect_error();
					}
					...
					$eval_con00 = mysqli_connect("vm1ip", "sampleuser", "samplepassword", "eval");
					if (mysqli_connect_errno())
					{
						echo "Failed to connect to MySQL: " . mysqli_connect_error();
					}
					...
					$eval_con7 = mysqli_connect("vm1ip", "sampleuser", "samplepassword", "eval");
					if (mysqli_connect_errno())
					{
						echo "Failed to connect to MySQL: " . mysqli_connect_error();
					}
					...
					$eval_con10 = mysqli_connect("vm1ip", "sampleuser", "samplepassword", "infocloud");
					if (mysqli_connect_errno())
					{
						echo "Failed to connect to MySQL: " . mysqli_connect_error();
					}
